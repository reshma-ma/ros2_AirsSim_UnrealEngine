...
class CommandConverterNode(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            ...
            10)
        self.get_logger().info("command converter Initialized")
        ...
        self.timer = self.create_timer(0.01, self.publish_car_control_commands)
        self.acceleration_rate = 0.2  # Rate at which the speed increases
    ...
    def update_command_values(self):
        if not self.handbrake_value:
    ...
    def publish_car_control_commands(self):
        self.update_command_values()
        throttle = Float64()
        steering = Float64()
        brake = Float64()
        handbrake = Bool()
